document.addEventListener("DOMContentLoaded", () => {
    ...
    document.getElementById("topicTitle").textContent = "Atomic Structure";
    ...
    videoGrid.innerHTML = `
        <div class="video-item">
            <iframe width="100%" height="180" src="https://www.youtube.com/embed/R07FXXwMB3s" 
...
document.getElementById("startQuiz").addEventListener("click", () => {
    window.location.href = "../bio4quizs/bioquiztp2.html"; // ✅ Redirects user to quiz page
});